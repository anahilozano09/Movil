...
import mx.unam.movil.sonido.Sonido
import mx.unam.movil.video.VideoActivity
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //binding para acceder a los recursos
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.evangelion->{
                startActivity(Intent(this,evangelion::class.java))
            }
            R.id.video->{
